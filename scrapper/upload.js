...
if(!process.env.ALGOLIA_APPLICATION_ID) throw new Error('ALGOLIA_APPLICATION_ID must be defined');
if(!process.env.ALGOLIA_ADMIN_KEY) throw new Error('ALGOLIA_ADMIN_KEY must be defined');
